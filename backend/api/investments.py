...
from backend.schemas.investment import InvestmentCreate, InvestmentUpdate, InvestmentOut
from backend.services.gamification import award_xp, check_achievements, XP_PER_INVESTMENT_LOG
