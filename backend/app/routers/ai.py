...
from backend.models import User, IncomeSource, Expense, Investment, Budget, SavingsGoal, Insurance, MonthlyReport
from backend.services.ai_service import analyze_finances
from backend.models.notification import NotificationType
from backend.services.gamification import _create_notification
