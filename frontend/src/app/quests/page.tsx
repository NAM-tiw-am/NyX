...
export default function QuestsPage() {
  const { level, selectedCharacter, quests, contributeQuest, isSidebarCollapsed } = useAppStore();
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-8 gap-4 border-b-[3px] border-black pb-6">
        <div>
          ...
          <p className="font-inter text-sm text-[#c6c6c6]">
            Complete these objectives to level up your financial status.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p className="font-mono text-[11px] text-[#e1bec2] uppercase flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">timer</span> EST. COMPLETION: {quest.estCompletion}
                </p>
              </div>
              ...
              <div className="mt-auto space-y-4">
                <div className="flex justify-between items-end font-mono text-xs">
                  <div>
                    <span className="text-[#c6c6c6] block text-[10px]">CURRENT LOOT</span>
                ...
                <button
                  ...
                  className="w-full bg-[#cb2957] text-white border-[3px] border-black py-3 font-mono text-xs font-bold uppercase brutalist-shadow flex justify-center items-center gap-2 hover:bg-[#ffb2bd] hover:text-black transition-colors mt-2"
                >
